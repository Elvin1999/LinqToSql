...
namespace LinqToSql
{
    ...
    partial void OnNameChanging(string value);
    partial void OnNameChanged();
    partial void OnappleChanging(string value);
    partial void OnappleChanged();
    partial void OnMyColumnChanging(string value);
    partial void OnMyColumnChanged();
    partial void OnMyColumn2Changing(string value);
    partial void OnMyColumn2Changed();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_apple", DbType="VarChar(25)")]
		public string apple
		{
			get
			{
			...
			set
			{
				if ((this._apple != value))
				{
					this.OnappleChanging(value);
					this.SendPropertyChanging();
					this._apple = value;
					this.SendPropertyChanged("apple");
					this.OnappleChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MyColumn", DbType="VarChar(25)")]
		public string MyColumn
		{
			...
			set
			{
				if ((this._MyColumn != value))
				{
					this.OnMyColumnChanging(value);
					this.SendPropertyChanging();
					this._MyColumn = value;
					this.SendPropertyChanged("MyColumn");
					this.OnMyColumnChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MyColumn2", DbType="VarChar(25)")]
		public string MyColumn2
		{
			get
			{
				return this._MyColumn2;
			}
			set
			{
				if ((this._MyColumn2 != value))
				{
					this.OnMyColumn2Changing(value);
					this.SendPropertyChanging();
					this._MyColumn2 = value;
					this.SendPropertyChanged("MyColumn2");
					this.OnMyColumn2Changed();
				}
			}
		}
